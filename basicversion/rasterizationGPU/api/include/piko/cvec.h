...
__host__ __device__ CVEC_FUNC void     clampInplace(float& val, const float& vmin=0.0f, const float& vmax=1.0f);
__host__ __device__ CVEC_FUNC void     clampInplace(cvec2f& v){ clampInplace(v.x); clampInplace(v.y); }
__host__ __device__ CVEC_FUNC void     clampInplace(cvec3f& v){ clampInplace(v.x); clampInplace(v.y); clampInplace(v.z); }
__host__ __device__ CVEC_FUNC void     clampInplace(cvec4f& v){ clampInplace(v.x); clampInplace(v.y); clampInplace(v.z); clampInplace(v.w); }

# 1 "/home/zhengzhen/workspace/versapipe/techniqueMegakernel.cu"
...
# 19
volatile int doneCounter[64]; 
# 20
volatile int endCounter[64]; 
# 22
int maxConcurrentBlocks[64]; 
# 23
volatile int maxConcurrentBlockEvalDone[64]; 
# 25
volatile int sm_flag[64 * 50]; 
# 28
int block_count[64 * 50]; 
# 30
int group_done_flag[64]; 
# 34
int *procIdArray_global; 
# 35
int taskCountArray[64]; 
# 37
int resultCounter[64]; 
# 39
}

# 1 "techniqueMegakernel.compute_60.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__38_techniqueMegakernel_compute_60_cpp1_ii_9bfa5aa3
# 1 "techniqueMegakernel.compute_60.cudafe1.stub.c"
#include "techniqueMegakernel.compute_60.cudafe1.stub.c"
# 1 "techniqueMegakernel.compute_60.cudafe1.stub.c"

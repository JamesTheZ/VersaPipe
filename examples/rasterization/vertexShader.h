...
//class VertexShaderStage : public Stage<VS_BINSIZE, VS_BINSIZE, 512, raster_wtri, raster_stri> {
		...
		__device__ __inline__ void zzAssignBin(raster_stri p, raster_stri *prims, int *index) {
			boundingBoxFixPt bb;
...
*/
		...
		__device__ __inline__ void process_new(raster_wtri p, raster_stri *prims, int *index)
		{
